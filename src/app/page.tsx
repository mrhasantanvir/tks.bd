...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfdfc] font-sans text-on-background selection:bg-primary/10 pt-16">
      <main>
        {/* Bright Analytical Hero Section (Screenshot Style) */}
        <section className="relative min-h-[30vh] flex flex-col items-center justify-center px-6 text-center overflow-hidden pt-8 pb-2">
